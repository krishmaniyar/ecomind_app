                    ...
                    children: [
                      ...
                      TextFormField(
                        decoration: textInputDecoration.copyWith(
                          hintText: 'Username', // Changed to "Username"
                          prefixIcon: Icon(Icons.person_outline, color: Colors.grey), // Person icon for username
                        ...
                        keyboardType: TextInputType.text, // Set for general text input
                        autocorrect: false,
                        autovalidateMode: AutovalidateMode.onUserInteraction,
                        validator: (val) => val == null || val.isEmpty ? 'Enter a username' : null, // Username validation
                        onChanged: (val) {
                          setState(() {
                            username = val;
                          });
                          ...
                          children: [
                            RichText(
                              text: TextSpan(
                                ...
                                children: [
                                  TextSpan(text: 'Already have an account? '), // Normal text
                                  WidgetSpan(
                                    child: TextButton(
                                      onPressed: () {
                                        widget.toggleView();
