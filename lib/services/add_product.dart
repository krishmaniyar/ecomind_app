...
class _AddProductState extends State<AddProduct> {
  ...
  // Form values
  Map _details = {};
  final List<String> categories = ['paper', 'metal', 'plastic', 'cardboard', 'glass', 'shoes', 'trash', 'clothes', 'battery', 'biological', 'other'];
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Price Field (Required, Only Numbers)
                        _buildTextField(
                          label: "Price",
  ...
  // Custom Input Field (All required)
  ...
  // Custom Dropdown Field (Required)
